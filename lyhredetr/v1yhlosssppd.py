...
if __name__ == '__main__':
    ...
    model = RTDETRyh1('ultralytics/cfg/models/rt-detr/llf/vis/v1losssppd.yaml')
    ...
    model.train(data='/home/liyihang/lyhredetr/dataset/VisDrone.yaml',
                ...
                workers=4,
                device=3,
                resume='/home/liyihang/lyhredetr/runs/vis/v1yhlosssppd_2/weights/last.pt', # last.pt path
