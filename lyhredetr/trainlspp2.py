...
if __name__ == '__main__':
    ...
    model = RTDETRyh1('ultralytics/cfg/models/rt-detr/llf/vis/lspp2.yaml')
    model.load(weights='/home/liyihang/lyhredetr/runs/vis/dev1yhloss_/weights/best.pt')# loading pretrain weights
