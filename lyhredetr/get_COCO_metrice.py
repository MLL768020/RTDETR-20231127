...
def parse_opt():
    parser = argparse.ArgumentParser()
    parser.add_argument('--anno_json', type=str, default='/home/liyihang/miji/uav_palm_data/annotations/instances_val2017.json', help='training model path')
    parser.add_argument('--pred_json', type=str, default='/home/liyihang/lyhredetr/runs/llf/valuav3/predictions.json', help='data yaml path')
