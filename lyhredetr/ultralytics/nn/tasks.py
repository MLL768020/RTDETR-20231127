...
class RTDETRDetection1Model(DetectionModel):
    """
    RTDETR (Real-time DEtection and Tracking using Transformers) Detection Model class.
    ...
    def init_criterion(self):
        """Initialize the loss criterion for the RTDETRDetectionModel."""
        from ultralytics.models.utils.loss import RTDETRDetection1Loss

        return RTDETRDetection1Loss(nc=self.nc, use_vfl=True)
...
class RTDETRDetectionyh1Model(DetectionModel):
    """
    RTDETR (Real-time DEtection and Tracking using Transformers) Detection Model class.
    ...
    def init_criterion(self):
        """Initialize the loss criterion for the RTDETRDetectionModel."""
        from ultralytics.models.utils.loss import RTDETRDetectionyhloss1

        return RTDETRDetectionyhloss1(nc=self.nc, use_vfl=True)
...
class RTDETRDetectionpyh1Model(DetectionModel):
    """
    RTDETR (Real-time DEtection and Tracking using Transformers) Detection Model class.
    ...
    def init_criterion(self):
        """Initialize the loss criterion for the RTDETRDetectionModel."""
        from ultralytics.models.utils.loss import RTDETRDetectionpyhloss1

        return RTDETRDetectionpyhloss1(nc=self.nc, use_vfl=True)
...
class RTDETRDetection2Model(DetectionModel):
    """
    RTDETR (Real-time DEtection and Tracking using Transformers) Detection Model class.
    ...
    def init_criterion(self):
        """Initialize the loss criterion for the RTDETRDetectionModel."""
        from ultralytics.models.utils.loss import RTDETRDetection2Loss

        return RTDETRDetection2Loss(nc=self.nc, use_vfl=True)
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 ConvNormLayer, DWRC3, C3_DWR, C2f_DWR, C3_DCNv2_Dynamic, C2f_DCNv2_Dynamic, BasicBlock_DCNv2_Dynamic,
                 BottleNeck_DCNv2_Dynamic, SPPD,
                 C3_DCNv2, C2f_DCNv2, BasicBlock_DCNv2, BottleNeck_DCNv2, C3_DCNv3, C2f_DCNv3, BasicBlock_DCNv3,
                 BottleNeck_DCNv3,
                 C3_iRMB, C2f_iRMB, C3_iRMB_Cascaded, C2f_iRMB_Cascaded, C3_Attention, C2f_Attention, C3_Ortho,
                 C2f_Ortho, HWD,
                 C3_DySnakeConv, C2f_DySnakeConv, DySnakeConv,
                 C3_Faster, C2f_Faster, C3_Faster_EMA, C2f_Faster_EMA, C3_Faster_Rep, C2f_Faster_Rep, C3_Faster_Rep_EMA,
                 C2f_Faster_Rep_EMA, CSP_EDLAN, Conv3XCC3, GSConv, VoVGSCSP, VoVGSCSPC,
                 C3_AggregatedAtt, C2f_AggregatedAtt, C2f_DBB, FSM, C2f_DAV, C2f_VSS, DBSPP,LSPP,
                 SELayer):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (
                    BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, DWRC3, C3_DWR, C2f_DWR, C3_DCNv2_Dynamic,
                    C2f_DCNv2_Dynamic,
                    ...
                    C3_Faster_Rep_EMA,
                    C2f_Faster_Rep_EMA, CSP_EDLAN, Conv3XCC3, C2f_DBB, C2f_DAV, C2f_VSS):
        ...
        #     args = [c1, args[0]]
            ...
            c2 = m.feature_info.channels()
        elif m in {convnextv2_atto, convnextv2_femto, convnextv2_pico, convnextv2_nano, convnextv2_tiny,
                   ...
                   vanillanet_5, vanillanet_6, vanillanet_7, vanillanet_8, vanillanet_9, vanillanet_10, vanillanet_11,
                   vanillanet_12, vanillanet_13, vanillanet_13_x1_5, vanillanet_13_x1_5_ada_pool,
                   #    RevCol,
                   lsknet_t, lsknet_s,
            ...
            m = m(*args)
            c2 = m.channel
        elif m in {ECM, EMA, SpatialAttention, BiLevelRoutingAttention, BiLevelRoutingAttention_nchw,
