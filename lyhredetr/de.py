...
# 修改输入图片文件夹
img_folder = "/home/liyihang/miji/coco/train/images/"
img_list = os.listdir(img_folder)
img_list.sort()
# 修改输入标签文件夹
label_folder = "/home/liyihang/miji/coco/train/labels/"
label_list = os.listdir(label_folder)
label_list.sort()
# 输出图片文件夹位置

output_folder = '/home/liyihang/miji/coco/train/output/'


colormap = [(0, 255, 0), (132, 112, 255), (0, 191, 255), (255, 12, 3), (28, 54, 62)]  # 色盘，可根据类别添加新颜色
