...
#            'roundabout', 'soccer - ball - field', 'swimming - po1']
# = ['pedestrian', 'people', 'bicycle', 'car', 'van', 'truck', 'tricycle', 'awning-tricycle', 'bus', 'motor']
parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='/home/liyihang/miji/uav_palm_data/val/images/', type=str,
                    help="path of images")
parser.add_argument('--label_path', default='/home/liyihang/miji/uav_palm_data/val/labels/', type=str,
                    help="path of labels .txt")
parser.add_argument('--save_path', type=str, default='/home/liyihang/miji/uav_palm_data/test_instances.json',
