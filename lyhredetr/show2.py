...
# 修改输入图片文件夹
img_folder = "/home/liyihang/miji/uav_palm_data/train/images/"
img_list = os.listdir(img_folder)
img_list.sort()
# 修改输入标签文件夹
label_folder = "/home/liyihang/miji/uav_palm_data/train/labels/"
label_list = os.listdir(label_folder)
label_list.sort()
# 输出图片文件夹位置
path = os.getcwd()
output_folder = "/home/liyihang/miji/uav_palm_data/train/out/"


colormap = [(0, 255, 0), (132, 112, 255), (0, 191, 255), (192, 26, 55), (221, 155, 110)]  # 色盘，可根据类别添加新颜色
