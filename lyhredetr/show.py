...
# 修改输入图片文件夹
img_folder = "/home/liyihang/miji/uav_palm_data/val/images/"
img_list = os.listdir(img_folder)
img_list.sort()
# 修改输入标签文件夹
label_folder = "/home/liyihang/miji/uav_palm_data/val/labels/"
label_list = os.listdir(label_folder)
label_list.sort()
# 输出图片文件夹位置
path = os.getcwd()
output_folder = "/home/liyihang/miji/uav_palm_data/val/out/"
# os.mkdir(output_folder)
# labels = ['truck', 'panzer', 'tank', 'SUV', 'cam_net', 'cam_tar']
colormap = [(0, 255, 0), (132, 112, 255), (0, 191, 255), (225, 32, 112), (150, 110, 12)]  # 色盘，可根据类别添加新颜色
